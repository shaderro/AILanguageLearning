...
const DEMO_TEXT = '春天来了，花开满山。'

export default function ChineseZhuyinSandbox({ onBack }) {
  ...
  const handleRun = async () => {
    ...
    setError('')
    try {
      const response = await apiService.previewChineseZhuyin(text)
      setResult(response)
    } catch (e) {
  ...
  return (
    <div className="mx-auto w-full max-w-4xl p-4">
      <div className="mb-3 flex items-center justify-between">
        <h1 className="text-xl font-semibold text-gray-900">Chinese Pinyin Sandbox</h1>
        <button
      ...
      {result ? (
        <div className="mt-5 space-y-4">
          ...
          <div>
            <div className="mb-2 text-sm font-medium text-gray-700">分字结果</div>
